...
const GradualBlur = (props) => {
  ...
  const blurDivs = useMemo(() => {
    ...
    for (let i = 1; i <= config.divCount; i++) {
      ...
      const divStyle = {
        ...
        /* Minimal background so backdrop-filter composites (required in some browsers) */
      ...
      divs.push(<div key={i} style={divStyle} aria-hidden="true" />);
    }
  ...
  return (
    <div
      ...
      style={{ ...containerStyle, isolation: 'isolate' }}
      onMouseEnter={hoverIntensity ? () => setIsHovered(true) : undefined}
      onMouseLeave={hoverIntensity ? () => setIsHovered(false) : undefined}
    >
      <div className="gradual-blur-inner relative w-full h-full" style={{ isolation: 'isolate' }}>
        {blurDivs}
      </div>
    </div>
  );
